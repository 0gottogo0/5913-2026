...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withKS(0.05).withKV(0.90).withKA(0)
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(6.48);

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = 1.5;

    public static final double kDriveGearRatio = 5.357142857142857;
    public static final double kSteerGearRatio = 18.75;
    public static final Distance kWheelRadius = Inches.of(1.95);
    public static final double kWheelCOF = 0.4;
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.14013671875);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.08642578125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.0029296875);
